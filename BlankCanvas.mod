...
<Document xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.datacontract.org/2004/07/RelicCore.ModProject">
				...
				<d2p1:anyType i:type="Folder">
					<Children>
						<d2p1:anyType i:type="BurnAttributes">
							<RelativeName>BlankCanvas.xml</RelativeName>
						</d2p1:anyType>
					</Children>
		...
		<d2p1:anyType i:type="TableOfContents">
			...
			<Children>
				<d2p1:anyType i:type="BurnModInfo">
					<Dependencies />
					<Description>For use with historical skin packs.</Description>
					<Hidden>false</Hidden>
					<Name>Blank Canvas</Name>
				</d2p1:anyType>
				<d2p1:anyType i:type="BurnFile">
					<BurnSettings i:nil="true" />
					<RelativeName>BlankCanvas.tga</RelativeName>
				</d2p1:anyType>
			</Children>
			<IsExpanded>true</IsExpanded>
		</d2p1:anyType>
	...
	<Guid>9cec380f-fb24-4cca-a7fc-0e9ffa64bae5</Guid>
	<IsExpanded>false</IsExpanded>
	<Type>DecalPack</Type>
</Document>